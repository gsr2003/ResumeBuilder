  ...
  return (
    <>
      ...
      <div className="contact" ref={scollToRef}>
        ...
        <div>
          <a href="https://x.com/iamGouravSR" target="_blank" rel="noopener noreferrer" className="link"><IoLogoTwitter className="social-icon" /></a>
          <a href="https://github.com/gsr2003" target="_blank" rel="noopener noreferrer" className="link"><IoLogoGithub className="social-icon" /></a>
        </div>
      </div>
